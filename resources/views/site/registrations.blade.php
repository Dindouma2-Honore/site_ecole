    ...
    <div class="container">
        ...
        <div class="reg-layout">
            ...
            <div class="reg-form-card">
                <form action="{{ route('registration.submit') }}" method="POST" id="regForm">
                    @csrf
            ...
            <div>
                ...
                <div class="reg-sidebar-card">
                    ...
                    <a href="{{ route('contact') }}" class="btn btn-outline" style="width:100%;text-align:center;display:block;border-color:var(--royal-blue);color:var(--royal-blue);">Nous contacter</a>
                </div>
            </div>
        </div>
