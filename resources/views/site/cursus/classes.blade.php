    ...
    <div class="container">
        ...
        <div class="level-cards-grid">
            ...
            <div class="level-card">
                ...
                <a href="{{ route('cursus.admission') }}" class="level-card-btn">En savoir plus <i class="bi bi-arrow-right"></i></a>
            </div>
            @endforeach
        </div>
    </div>
...
<section class="cta-band">
    <div class="container cta-band-inner">
        ...
        <div class="cta-band-actions">
            <a href="{{ route('contact') }}" class="btn btn-outline" style="border-color:var(--royal-blue);color:var(--royal-blue);"><i class="bi bi-calendar-check"></i> Prendre rendez-vous</a>
            <a href="{{ route('registrations') }}" class="btn btn-primary"><i class="bi bi-pencil-square"></i> Inscription en ligne</a>
        </div>
    </div>
</section>
@endsection
